  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-[338px] flex flex-col justify-between mb-8 md:mb-0">
        <div>
          <div className="font-mono text-base tracking-[-0.8px] mb-8 md:mb-20">{serviceNumber}</div>
      ...
      <div className="w-full md:w-[432px]">
        ...
        {/* This part should stay as a row on small screens and up */}
        <div className="flex flex-col sm:flex-row justify-between">
          <div className="w-full sm:w-[211px] mb-6 sm:mb-0">
